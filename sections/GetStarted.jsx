...
const GetStarted = () => (
  <motion.section
    ...
    className={`${styles.xPaddings} text-white flex flex-col lg:flex-row items-center justify-center gap-5`}
  >
    ...
    >
      <TypingText
        ...
        textStyles="relative right-24 bottom-12"
      />
      <h1 className="text-7xl font-bold max-w-3xl">
      ...
      <div className="flex items-start w-full flex-col gap-5 mt-10">
        {startingFeatures.map((item, index) => (
          <div key={index} className="flex  items-center gap-5">
            ...
            <div className="text-secondary-white font-semibold lg:max-w-[15rem]  ">
              {item}
            </div>
          </div>
        ))}
